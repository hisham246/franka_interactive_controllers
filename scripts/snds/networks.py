...
from snds.group_sort import GroupSort
from snds.bjorck_linear import BjorckLinear
from torch.autograd import Variable


class NN(nn.Module):
    def __init__(self, input_shape: int = 3, output_shape: int = 3):
...
class LSTM(nn.Module):
    def __init__(self, input_shape: int = 3, output_shape: int = 3, hidden_size: int = 2,
        num_layers: int = 1):
        """ Build a neural network module using torch.
