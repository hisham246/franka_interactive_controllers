...
def main():
    ...
    lipo_blending_horizon = 9  # How many steps to blend between chunks
    ...
    lipo = ActionLiPo(
        ...
        dt=dt,
        epsilon_blending=0.03,  # Allow more deviation in blending zone
        epsilon_path=0.002     # Tighter constraint for main trajectory
    )
